...
<%List<Prodotto> listaProdottiAcquisto = (List<Prodotto>) request.getAttribute("listaProdottiAcquisto"); %>
...
Prodotto prodotto = listaProdottiAcquisto.get(listaAcquisti.indexOf(acquisto));%>
