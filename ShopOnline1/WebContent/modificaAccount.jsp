...
<form class="form-horizontal"  action="ModificaAccount" method ="post"  onsubmit="return validazioneForm()" id="formRegistrazione" style="margin-left: 50px">
...
<div class="rowgrid"   style="width: 40%;margin-left: 800px;margin-top: -400px;"> 
  ...
  <div class="column">
    ...
    <img src="img/romanzo1.jpg" style="width:150%; margin-top: -30px;margin: 45px;">
  </div>  
